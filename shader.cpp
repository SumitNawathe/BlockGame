...
Shader::Shader(const char* vertexPath, const char* fragmentPath) {
	...
	try {
		...
		if constexpr (DEBUG) std::cout << "ERROR::SHADER::FILE_NOT_SUCCESSFULLY_READ" << std::endl;
	}
	...
	if (!success) {
		...
		if constexpr (DEBUG) std::cout << "ERROR::SHADER::VERTEX::COMPILATION_FAILED\n" << infoLog << std::endl;
	}
	...
	if (!success) {
		...
		if constexpr (DEBUG) std::cout << "ERROR::SHADER::FRAGMENT::COMPILATION_FAILED\n" << infoLog << std::endl;
	}
	...
	if (!success) {
		...
		if constexpr (DEBUG) std::cout << "ERROR::SHADER::PROGRAM::LINKING_FAILED\n" << infoLog << std::endl;
	}
